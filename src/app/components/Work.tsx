...
const itemVariants = {
  ...
  animate: { opacity: 1, x: 0, transition: { duration: 0.6, ease: [0.22, 1, 0.36, 1] as const } },
};
  ...
  return (
    <div className="pt-24 px-4">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
        ...
        <div 
          className="lg:col-span-6 lg:sticky lg:top-24 lg:h-[calc(100vh-120px)] rounded-3xl overflow-hidden bg-[#050505] relative cursor-pointer group"
        ...
        >
          ...
          >
            <div className="flex flex-col gap-4">
               <h2 className="text-white text-5xl md:text-6xl font-light tracking-tighter">My Portfolio</h2>
               <p className="text-white/40 text-sm max-w-sm leading-relaxed">
                 A creative showcase of selected works from portfolio v1.
               </p>
            </div>
